...
import com.loopy.loopypowers.network.payload.PowerRitualTickPayload;
...
public class PowerRitual implements RitualInterface {
    ...
    public boolean tick(ServerLevel world) {
        ...
        PacketDistributor.sendToPlayersTrackingEntityAndSelf(sp, new PowerRitualTickPayload(sp.getId(), ticks));
