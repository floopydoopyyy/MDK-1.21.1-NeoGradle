...
import com.loopy.loopypowers.network.payload.RuinRitualTickPayload;
...
public class RuinRitual implements RitualInterface {
    ...
    public boolean tick(ServerLevel world) {
        ...
        PacketDistributor.sendToPlayersTrackingEntityAndSelf(sp, new RuinRitualTickPayload(sp.getId(), ticks));
    ...
    private void onComplete(ServerPlayer sp, ServerLevel world) {
        Supplier<PowerInterface> factory = RUIN_POWERS.get(sp.getRandom().nextInt(RUIN_POWERS.size()));
