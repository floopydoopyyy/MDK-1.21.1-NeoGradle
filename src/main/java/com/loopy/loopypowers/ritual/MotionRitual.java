...
import com.loopy.loopypowers.network.payload.MotionRitualTickPayload;
...
public class MotionRitual implements RitualInterface {
    ...
    public boolean tick(ServerLevel world) {
        ...
        PacketDistributor.sendToPlayersTrackingEntityAndSelf(sp, new MotionRitualTickPayload(sp.getId(), ticks));
    ...
    private void onComplete(ServerPlayer sp, ServerLevel world) {
        Supplier<PowerInterface> factory = MOTION_POWERS.get(sp.getRandom().nextInt(MOTION_POWERS.size()));
