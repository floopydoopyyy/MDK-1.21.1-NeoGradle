...
public class RuinVestigeItem extends Item {

    public RuinVestigeItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltip, TooltipFlag type) {
        tooltip.add(Component.translatable("item.loopypowers.ruin_vestige.tooltip.flavor")
                .withStyle(ChatFormatting.GRAY));

        tooltip.add(Component.translatable("item.loopypowers.ruin_vestige.tooltip.desc")
                .withStyle(ChatFormatting.LIGHT_PURPLE));

        tooltip.add(Component.translatable("item.loopypowers.vestige.tooltip.available")
                .withStyle(ChatFormatting.GRAY));
        tooltip.add(Component.translatable("item.loopypowers.ruin_vestige.tooltip.powers")
                .withStyle(ChatFormatting.GRAY));
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player user, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ...
            RitualManager.startRitual(player, RitualManager.RitualType.RUIN_VESTIGE);
