...
public class PowerVestigeItem extends Item {
    ...
    public PowerVestigeItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltip, TooltipFlag type) {
        tooltip.add(Component.translatable("item.loopypowers.power_vestige.tooltip.flavor")
                .withStyle(ChatFormatting.GRAY));

        tooltip.add(Component.translatable("item.loopypowers.power_vestige.tooltip.desc")
