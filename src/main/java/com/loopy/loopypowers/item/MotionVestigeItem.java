...
public class MotionVestigeItem extends Item {
    ...
    public MotionVestigeItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltip, TooltipFlag type) {
        tooltip.add(Component.translatable("item.loopypowers.motion_vestige.tooltip.flavor")
                .withStyle(ChatFormatting.GRAY));

        tooltip.add(Component.translatable("item.loopypowers.motion_vestige.tooltip.desc")
                .withStyle(ChatFormatting.LIGHT_PURPLE));

        tooltip.add(Component.translatable("item.loopypowers.vestige.tooltip.available")
                .withStyle(ChatFormatting.GRAY));
        tooltip.add(Component.translatable("item.loopypowers.motion_vestige.tooltip.powers")
                .withStyle(ChatFormatting.GRAY));
    }
